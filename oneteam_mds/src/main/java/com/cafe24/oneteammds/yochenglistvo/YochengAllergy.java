...
public class YochengAllergy {
	...
	public String toString() {
		return "YochengAllergy [yochengCode=" + yochengCode + ", yochengoutHospitalName=" + yochengoutHospitalName
				+ ", yochenginHospitalName=" + yochenginHospitalName + ", patientId=" + patientId + ", patientName="
				+ patientName + ", yochengJinlyoCode=" + yochengJinlyoCode + ", aseCode=" + aseCode + ", asemFactor="
