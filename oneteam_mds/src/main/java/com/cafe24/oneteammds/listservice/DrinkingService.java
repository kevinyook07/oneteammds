...
public class DrinkingService {
	...
	// 음주상태 검색
	public List<Drinkingh> getDrinkingSearchList(String hospitalId, String sk1, String sk2, String sv1, String sv2, String start_date, String finish_date) {

		List<Drinkingh> list = drinkingMapper.getDrinkingSearchList(hospitalId, sk1, sk2, sv1, sv2, start_date, finish_date);
	...
	// MDS DB - 음주상태 검색
	public List<Drinking> getDrinkingdbSearchList(String sk1, String sk2, String sk3, String sv1, String sv2, String sv3, String start_date, String finish_date) {

		List<Drinking> list = drinkingMapper.getDrinkingdbSearchList(sk1, sk2, sk3, sv1, sv2, sv3, start_date, finish_date);
