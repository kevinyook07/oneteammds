...
public class YoungsangService {
	...
	public List<Youngsangh> getYoungsangSearchList(String hospitalId, String sk1, String sk2, String sv1, String sv2, String start_date, String finish_date) {
		...
		List<Youngsangh> list = youngsangMapper.getYoungsangSearchList(hospitalId, sk1, sk2, sv1, sv2, start_date, finish_date);
	...
	// MDS DB - 영상검사결과 검색
	public List<Youngsang> getYoungsangdbSearchList(String sk1, String sk2, String sk3, String sv1, String sv2, String sv3, String start_date, String finish_date) {

		List<Youngsang> list = youngsangMapper.getYoungsangdbSearchList(sk1, sk2, sk3, sv1, sv2, sv3, start_date, finish_date);
