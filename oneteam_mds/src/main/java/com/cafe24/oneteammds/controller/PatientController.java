...
public class PatientController {
	...
	public String getPatientList(@RequestParam(value = "sk3") String sk3, @RequestParam(value = "sv3") String sv3,
			Model model) {
	...
	public String modifyPatient(@RequestParam(value = "patientId") String patientId, Model model) {
	...
	public String delPatient(@RequestParam(value = "patientId") String patientId, Model model) {
		model.addAttribute("patientId", patientId);

		return "patient/delPatient/delPatient";
	}

	// 환자 권한 회원 삭제 및 유효성 검사
	@PostMapping("/delPatient")
	public String delPatient(Patient patient, Model model) {

		int result = patientService.deletePatient(patient.getP_id(), patient.getP_pw());
