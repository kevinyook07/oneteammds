...
public class TotalController {
	...
	public String getTotalRegist(Total total, Model model) {
	...
	public String getJindanhByCode(@RequestParam(value="dbCode")String dbCode
								 , Jindan jindan
								 , Model model) {
	...
	public String getYakmulByCode(@RequestParam(value="mbCode")String mbCode
								, Yakmul yakmul
								, Model model) {
	...
	public String getGumcheByCode(@RequestParam(value="strCode")String strCode
								, Gumche gumche
								, Model model) {
	...
	public String getByungriByCode(@RequestParam(value="ptrCode")String ptrCode
								 , Byungri byungri
								 , Model model) {
	...
	public String getYoungsangByCode(@RequestParam(value="itrCode")String itrCode
								   , Youngsang youngsang
								   , Model model) {
	...
	public String getPandogByCode(@RequestParam(value="iidCode")String iidCode
								, Pandog pandog
								, Model model) {
	...
	public String getGinuengByCode(@RequestParam(value="ftrCode")String ftrCode
								 , Ginueng ginueng
								 , Model model) {
	...
	public String getSusulByCode(@RequestParam(value="sbCode")String sbCode
							   , Susul susul
							   , Model model) {
	...
	public String getAllergyByCode(@RequestParam(value="aseCode")String aseCode
								 , Allergy allergy
								 , Model model) {
	...
	public String getYebangByCode(@RequestParam(value="pibCode")String pibCode
								, Yebang yebang
								, Model model) {
	...
	public String getSaengchaeByCode(@RequestParam(value="vscCode")String vscCode
								   , Saengchae saengchae
								   , Model model) {
	...
	public String getSmokingByCode(@RequestParam(value="scCode")String scCode
								 , Smoking smoking
								 , Model model) {
	...
	public String getDrinkingByCode(@RequestParam(value="dcCode")String dcCode
								  , Drinking drinking
								  , Model model) {
	...
	public String getJunyumByCode(@RequestParam(value="lcidCode")String lcidCode
								, Junyum junyum
								, Model model) {
	...
	public String getTotalReplace(@RequestParam(value="dbCode")String dbCode
								, @RequestParam(value="mbCode")String mbCode
								, @RequestParam(value="strCode")String strCode
								, @RequestParam(value="ptrCode")String ptrCode
								, @RequestParam(value="itrCode")String itrCode
								, @RequestParam(value="iidCode")String iidCode
								, @RequestParam(value="ftrCode")String ftrCode
								, @RequestParam(value="sbCode")String sbCode
								, @RequestParam(value="aseCode")String aseCode
								, @RequestParam(value="pibCode")String pibCode
								, @RequestParam(value="vscCode")String vscCode
								, @RequestParam(value="scCode")String scCode
								, @RequestParam(value="dcCode")String dcCode
								, @RequestParam(value="lcidCode")String lcidCode
								, Jindan jindan
								, Yakmul yakmul
								, Gumche gumche
								, Byungri byungri
