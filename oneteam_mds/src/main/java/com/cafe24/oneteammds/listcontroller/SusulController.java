...
public class SusulController {
	...
	public String getSusulList(@RequestParam(value = "hospitalId") String hospitalId
							  ...
							  , Model model) {
		List<Susulh> list = susulService.getSusulSearchList(hospitalId, sk1, sk2, sv1, sv2, start_date, finish_date);
	...
	public String getSusuldbList(@RequestParam(value = "sk1") String sk1
							    ,@RequestParam(value = "sk2") String sk2
								...
								,@RequestParam(value = "finish_date") String finish_date,
			Model model) {
		List<Susul> list = susulService.getSusuldbSearchList(sk1, sk2, sk3, sv1, sv2, sv3, start_date, finish_date);
